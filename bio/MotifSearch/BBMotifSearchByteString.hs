module BBMotifSearchByteString where
...
-- Branch-and-Bound median string search using ByteString data type instead of String. ByteString helps to increase performance.
